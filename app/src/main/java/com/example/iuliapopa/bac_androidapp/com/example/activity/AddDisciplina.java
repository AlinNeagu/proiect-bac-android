...
public class AddDisciplina extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button addDisciplina =(Button)findViewById(R.id.addDisciplina);
    ...
    public void addDisciplina(){
        ...
        String url = "http://10.0.2.2:8080/ProiectBAC/disciplina?disciplina="+numeDisciplina.getText();
