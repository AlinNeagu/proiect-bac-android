...
public class EditProfil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText e=(EditText)findViewById(R.id.numeProfil);
        e.setText(nume);

        Button btn=(Button)findViewById(R.id.editProfil);
    ...
    public void editProfil(){
        ...
        String url = "http://10.0.2.2:8080/ProiectBAC/updateProfil?idProfil="+id+"&nume="+numeProfil.getText();
